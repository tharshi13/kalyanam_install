...
class AddUserForm
{
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Radio(t('Gender:'), 'sex', array('female' => t('Woman'), 'male' => t('Man')), array('value' => 'female', 'required' => 1)));
        $oForm->addElement(new \PFBC\Element\Checkbox(t('Looking for:'), 'match_sex', array('male' => t('Man'), 'female' => t('Woman')), array('value' => 'male', 'required' => 1)));
