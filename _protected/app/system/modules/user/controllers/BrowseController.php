...
class BrowseController extends Controller
{
    ...
    public function index()
    {
        ...
        if (empty($oUsers)) {
            ...
            $this->view->h3_title = t('Find your soulmate at %0%', '<span class="pH0">' . $this->registry->site_name . '</span>');
            $this->view->meta_description = t('Find your special someone at %site_name% - Browse Members');
